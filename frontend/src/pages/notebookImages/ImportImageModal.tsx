...
export type ImportImageModalProps = {
    isOpen: boolean;
    onCloseHandler: () => any;
    onImportHandler(name: string, repository: string, description: string);
}
export const ImportImageModal: React.FC<ImportImageModalProps> = ({ isOpen, onImportHandler, onCloseHandler }) => {
    ...
    return (
        <Modal
            ...
            actions={[
                <Button key="confirm" variant="primary" onClick={() => {
                    onImportHandler(name, repository, description);
                    onCloseHandler();
                }}>
                    Import
                </Button>,
        ...
        >
            <Form>
                ...
                <FormGroup
                    label="Description"
                    fieldId="notebook-image-description"
                >
                    <TextInput
                        isRequired
                        type="text"
